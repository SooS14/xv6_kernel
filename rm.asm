...
_rm:     format de fichier elf32-i386
...
main(int argc, char *argv[])
{
  ...
  51:	50                   	push   %eax
  52:	e8 56 03 00 00       	call   3ad <unlink>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 47f:	0f b6 91 24 0b 00 00 	movzbl 0xb24(%ecx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 5bd:	75 25                	jne    5e4 <printf+0x103>
          s = "(null)";
 5bf:	c7 45 f4 d5 08 00 00 	movl   $0x8d5,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 68a:	a1 40 0b 00 00       	mov    0xb40,%eax
 ...
 755:	a3 40 0b 00 00       	mov    %eax,0xb40
}
 75a:	90                   	nop
 75b:	c9                   	leave  
 75c:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 7b7:	83 c4 10             	add    $0x10,%esp
  return freep;
 7ba:	a1 40 0b 00 00       	mov    0xb40,%eax
}
 7bf:	c9                   	leave  
 7c0:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 7d7:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 7da:	a1 40 0b 00 00       	mov    0xb40,%eax
 7df:	89 45 f0             	mov    %eax,-0x10(%ebp)
 7e2:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 7e6:	75 23                	jne    80b <malloc+0x4a>
    base.s.ptr = freep = prevp = &base;
 7e8:	c7 45 f0 38 0b 00 00 	movl   $0xb38,-0x10(%ebp)
 7ef:	8b 45 f0             	mov    -0x10(%ebp),%eax
 7f2:	a3 40 0b 00 00       	mov    %eax,0xb40
 7f7:	a1 40 0b 00 00       	mov    0xb40,%eax
 7fc:	a3 38 0b 00 00       	mov    %eax,0xb38
    base.s.size = 0;
 801:	c7 05 3c 0b 00 00 00 	movl   $0x0,0xb3c
 808:	00 00 00 
  }
 ...
 85e:	a3 40 0b 00 00       	mov    %eax,0xb40
      return (void*)(p + 1);
 ...
 869:	eb 3b                	jmp    8a6 <malloc+0xe5>
    ...
    if(p == freep)
 86b:	a1 40 0b 00 00       	mov    0xb40,%eax
